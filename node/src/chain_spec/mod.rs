...
pub(crate) fn build_local_properties() -> Properties {
...
pub(crate) fn get_authority_keys_from_seed(
    seed: &str,
) -> (
    AccountId,
    AccountId,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, ChainSpecExtension, Default)]
