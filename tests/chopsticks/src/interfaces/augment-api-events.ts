...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    allocations: {
       ...
       **/
      SessionQuotaCalculated: AugmentedEvent<ApiType, [u128]>;
      /**
       * Session quota is renewed at the beginning of a new session
       **/
      SessionQuotaRenewed: AugmentedEvent<ApiType, []>;
      /**
       * Generic event
       **/
    ...
    companyReserve: {
       ...
       **/
      ReserveOp: AugmentedEvent<ApiType, [Result<Null, SpRuntimeDispatchError>]>;
      /**
       * Some funds were spent from the reserve.
       **/
      SpentFunds: AugmentedEvent<ApiType, [AccountId32, u128]>;
      /**
       * Someone tipped the company reserve
       **/
      TipReceived: AugmentedEvent<ApiType, [AccountId32, u128]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    mandate: {
       ...
       **/
      RootOp: AugmentedEvent<ApiType, [Result<Null, SpRuntimeDispatchError>]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    vesting: {
       ...
       **/
      VestingScheduleAdded: AugmentedEvent<ApiType, [AccountId32, AccountId32, PalletGrantsVestingSchedule]>;
      /**
       * Canceled all vesting schedules \[who\]
       **/
      VestingSchedulesCanceled: AugmentedEvent<ApiType, [AccountId32]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
