...
parameter_types! {
    ...
    pub const StakingMinStakeSessionSelection: Balance = 10;
    pub const StakingMinValidatorBond: Balance = 10;
    pub const StakingMinNominatorTotalBond: Balance = 5;
    pub const StakingMinNominationChillThreshold: Balance = 3;
