...
use crate::{
    constants, Allocations, Call, Event, FinancialCommittee, Origin, OriginCaller, RootCommittee,
    Runtime, Scheduler, TechnicalCommittee,
};
...
parameter_types! {
    pub const CompanyReserveModuleId: PalletId = PalletId(*b"py/resrv"); // 5EYCAe5ijiYfha9GzQDgPVtUCYDY9B8ZgcyiANL2L34crMoR
}
...
impl pallet_reserve::Config<pallet_reserve::Instance1> for Runtime {
    ...
    type Call = Call;
    type PalletId = CompanyReserveModuleId;
    type WeightInfo = pallet_reserve::weights::SubstrateWeight<Runtime>;
}

parameter_types! {
    pub const InternationalReserveModuleId: PalletId = PalletId(*b"py/rvint"); // 5EYCAe5ijiYfi6GQAEPSHYDwvw4CkyGtPTS52BjLh42GygSv
}
...
impl pallet_reserve::Config<pallet_reserve::Instance2> for Runtime {
    ...
    type ExternalOrigin =
        pallet_collective::EnsureProportionMoreThan<_1, _2, AccountId, FinancialCollective>;
    type Call = Call;
    type PalletId = InternationalReserveModuleId;
    type WeightInfo = pallet_reserve::weights::SubstrateWeight<Runtime>;
}

parameter_types! {
    pub const UsaReserveModuleId: PalletId = PalletId(*b"py/rvusa"); // 5EYCAe5ijiYfi6MEfWpZC3nJ38KFZ9EQSFpsj9mgYgTtVNri
}
...
impl pallet_reserve::Config<pallet_reserve::Instance3> for Runtime {
    ...
    type ExternalOrigin =
        pallet_collective::EnsureProportionMoreThan<_1, _2, AccountId, FinancialCollective>;
    type Call = Call;
    type PalletId = UsaReserveModuleId;
    type WeightInfo = pallet_reserve::weights::SubstrateWeight<Runtime>;
}
