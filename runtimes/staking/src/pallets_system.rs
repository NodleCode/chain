...
use crate::{
	constants, version::VERSION, Babe, Balances, Call, Event, Origin, PalletInfo, Runtime, SignedExtra, SignedPayload,
...
parameter_types! {
	pub const ExistentialDeposit: Balance = constants::MILLICENTS;
