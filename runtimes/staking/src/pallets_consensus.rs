...
parameter_types! {
    ...
    pub const ValidatorFee: Perbill = Perbill::from_percent(20);
    pub const SlashRewardProportion: Perbill = Perbill::from_percent(10);
    pub const SlashRewardFraction: Perbill = Perbill::from_percent(50);
    pub const StakingMaxValidators: u32 = 50;
    pub const StakingMinStakeSessionSelection: Balance = 10 * constants::MILLICENTS;
    pub const StakingMinValidatorBond: Balance = 10 * constants::MILLICENTS;
    pub const StakingMinNominatorTotalBond: Balance = 10 * constants::MILLICENTS;
    pub const StakingMinNominationChillThreshold: Balance = 3 * constants::MILLICENTS;
...
impl pallet_staking::Config for Runtime {
    ...
    type ValidatorFee = ValidatorFee;
    type SlashRewardProportion = SlashRewardProportion;
    type SlashRewardFraction = SlashRewardFraction;
    type StakingMaxValidators = StakingMaxValidators;
    type StakingMinValidatorBond = StakingMinValidatorBond;
    type StakingMinStakeSessionSelection = StakingMinStakeSessionSelection;
    type StakingMinNominatorTotalBond = StakingMinNominatorTotalBond;
    type StakingMinNominationChillThreshold = StakingMinNominationChillThreshold;
