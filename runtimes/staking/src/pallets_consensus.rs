...
use crate::{
	constants, pallets_governance::RootCollective, AuthorityDiscovery, Babe, Balances, Call, Event, Grandpa,
	Historical, ImOnline, Offences, Runtime, Session, Staking,
};
use frame_support::{
	parameter_types,
...
use sp_runtime::{impl_opaque_keys, traits::OpaqueKeys, transaction_validity::TransactionPriority, Perbill};
use sp_std::prelude::*;
...
impl pallet_staking::Config for Runtime {
	...
	type CancelOrigin = pallet_collective::EnsureProportionMoreThan<AccountId, RootCollective, 1, 2>;
