...
impl<T: frame_system::Config> pallet_allocations::WeightInfo for WeightInfo<T> {
	...
	fn allocate(b: u32, ) -> Weight {
		// Minimum execution time: 119_238 nanoseconds.
		Weight::from_parts(177_651_895_u64, 0)
			// Standard Error: 321_871
			.saturating_add(Weight::from_parts(41_438_159_u64, 0).saturating_mul(b as u64))
	...
	fn calc_quota() -> Weight {
		// Minimum execution time: 8_284 nanoseconds.
		Weight::from_parts(8_533_000_u64, 0)
	...
	fn renew_quota() -> Weight {
		// Minimum execution time: 8_071 nanoseconds.
		Weight::from_parts(8_501_000_u64, 0)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn checked_update_session_quota() -> Weight {
		...
		Weight::from_parts(16_476_000_u64, 0)
	...
	fn set_curve_starting_block() -> Weight {
		...
		Weight::from_parts(7_501_000_u64, 0)
