...
impl<T: frame_system::Config> pallet_allocations::WeightInfo for WeightInfo<T> {
	...
	fn allocate(b: u32) -> Weight {
		// Minimum execution time: 120_050 nanoseconds.
		Weight::from_parts(5_663_675_u64, 0)
			// Standard Error: 14_735
			.saturating_add(Weight::from_parts(46_663_851_u64, 0).saturating_mul(b as u64))
	...
	fn renew_quota() -> Weight {
		...
		Weight::from_parts(5_340_000_u64, 0)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn set_curve_starting_block() -> Weight {
		...
		Weight::from_parts(4_800_000_u64, 0)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
}
