...
impl<T: frame_system::Config> pallet_grants::WeightInfo for WeightInfo<T> {
	...
	fn add_vesting_schedule() -> Weight {
		// Minimum execution time: 92_650 nanoseconds.
		Weight::from_parts(96_440_000_u64, 0)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(41_440_000_u64, 0)
	...
	fn cancel_all_vesting_schedules() -> Weight {
		// Minimum execution time: 123_600 nanoseconds.
		Weight::from_parts(126_619_000_u64, 0)
	...
	fn bridge_all_vesting_schedules() -> Weight {
		// Minimum execution time: 89_600 nanoseconds.
		Weight::from_parts(91_990_000_u64, 0)
	...
	fn set_bridge() -> Weight {
		...
		Weight::from_parts(6_950_000_u64, 0)
	...
	fn remove_bridge() -> Weight {
		...
		Weight::from_parts(6_991_000_u64, 0)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	// Proof: `Vesting::Renounced` (`max_values`: None, `max_size`: Some(49), added: 2524, mode: `MaxEncodedLen`)
	fn renounce() -> Weight {
		// Minimum execution time: 7_780 nanoseconds.
		Weight::from_parts(8_140_000_u64, 0).saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
