...
impl<T: frame_system::Config> pallet_reserve::WeightInfo for WeightInfo<T> {
	...
	fn tip() -> Weight {
		// Minimum execution time: 56_909 nanoseconds.
		Weight::from_parts(60_245_000_u64, 0)
	...
	// Proof: `System::Account` (`max_values`: None, `max_size`: Some(128), added: 2603, mode: `MaxEncodedLen`)
	fn spend() -> Weight {
		// Minimum execution time: 60_913 nanoseconds.
		Weight::from_parts(62_212_000_u64, 0)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}
