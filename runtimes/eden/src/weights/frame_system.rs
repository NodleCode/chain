...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	fn remark(_b: u32) -> Weight {
		Weight::from_ref_time(36_543_000_u64)
	}
	fn remark_with_event(b: u32) -> Weight {
	...
	fn set_heap_pages() -> Weight {
		Weight::from_ref_time(11_149_000_u64)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	fn set_storage(i: u32) -> Weight {
		Weight::from_ref_time(4_090_000_u64)
			// Standard Error: 5_000
			.saturating_add(Weight::from_ref_time(786_000).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i as u64)))
	}
	fn kill_storage(i: u32) -> Weight {
		Weight::from_ref_time(716_000_u64)
			// Standard Error: 3_000
			.saturating_add(Weight::from_ref_time(634_000).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i as u64)))
	}
	fn kill_prefix(p: u32) -> Weight {
		Weight::from_ref_time(2_100_000_u64)
			// Standard Error: 4_000
			.saturating_add(Weight::from_ref_time(1_261_000).saturating_mul(p as u64))
