...
sp_api::impl_runtime_apis! {
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		fn benchmark_metadata(extra: bool) -> (
			...
			list_benchmark!(list, extra, pallet_mandate, Mandate);
			// list_benchmark!(list, extra, pallet_randomness_collective_flip, RandomnessCollectiveFlip);
		...
		fn dispatch_benchmark(
			...
			add_benchmark!(params, batches, pallet_mandate, Mandate);
			// add_benchmark!(params, batches, pallet_randomness_collective_flip, RandomnessCollectiveFlip);
